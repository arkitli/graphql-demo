...
// 1. 在假資料中補充朋友資訊
const users = [
  { id: 1, name: 'Fong', age: 23, friendIds: [2, 3], height: 170, weight: 60 },
  { id: 2, name: 'Kevin', age: 40, friendIds: [1], height: 160, weight: 65 },
  { id: 3, name: 'Mary', age: 18, friendIds: [1], height: 180, weight: 80 }
];
